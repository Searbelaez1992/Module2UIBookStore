...
public class BookingWebController {
    ...
    public BookingWebController(BookingService bookingService, ProductService productService, UsersService usersService, BookingStatusService bookingStatusService) {
