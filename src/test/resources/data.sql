INSERT INTO PRODUCT (NAME, DESCRIPTION, AUTHOR, PRICE,IMAGE_PATH) VALUES ('Don Quixote', 'The final and greatest utterance of the human mind." -- Fyodor Dostoyevsky. ','Miguel de Cervantes Saavedra', 100, 'https://coverart.oclc.org/ImageWebSvc/oclc/+-+3584215756_140.jpg');
INSERT INTO PRODUCT (NAME, DESCRIPTION, AUTHOR, PRICE,IMAGE_PATH) VALUES ('Alices adventures in wonderland', 'This edition brings together the complete and unabridged text with more than 70 stunning illustrations by Robert Ingpen','Lewis Carroll', 22, 'https://coverart.oclc.org/ImageWebSvc/oclc/+-+9826578756_140.jpg');
INSERT INTO PRODUCT (NAME, DESCRIPTION, AUTHOR, PRICE,IMAGE_PATH) VALUES ('The adventures of Tom Sawyer', 'The adventures of a mischievous young boy and his friends growing up in a Mississippi River town in the nineteenth century. ','Mark Twain', 35, 'https://coverart.oclc.org/ImageWebSvc/oclc/+-+04429400_140.jpg');
INSERT INTO PRODUCT (NAME, DESCRIPTION, AUTHOR, PRICE,IMAGE_PATH) VALUES ('To Kill a Mockingbird', 'The unforgettable novel of a childhood in a sleepy Southern town and the crisis of conscience that rocked it. ','Harper Lee', 44, 'https://images-na.ssl-images-amazon.com/images/S/compressed.photo.goodreads.com/books/1553383690i/2657.jpg');
...
INSERT INTO USERS (NAME, ADDRESS, EMAIL, PHONE, ROLE_ID, LOGIN, PASSWORD) VALUES ('Andrea','street 50','andre@gmail.com', '3108888002',(SELECT ROLE_ID FROM ROLE WHERE NAME = 'CUSTOMER'), 'andriucar','Test321');
INSERT INTO USERS (NAME, ADDRESS, EMAIL, PHONE, ROLE_ID, LOGIN, PASSWORD) VALUES ('David','street 51','david@gmail.com', '3108888003',(SELECT ROLE_ID FROM ROLE WHERE NAME = 'CUSTOMER'), 'DAVID','Test555');
...
INSERT INTO BOOKING (USER_ID,PRODUCT_ID,DELIVERY_ADDRESS,DELIVERY_DATE,DELIVERY_TIME,BOOKINGSTATUS_ID,QUANTITY) VALUES ((SELECT USER_ID FROM USERS WHERE NAME = 'Sebastian'),(SELECT PRODUCT_ID FROM PRODUCT WHERE NAME = 'The adventures of Tom Sawyer'),(SELECT ADDRESS FROM USERS WHERE NAME = 'Sebastian'),'2024-04-29', '13:30',(SELECT BOOKINGSTATUS_ID FROM BOOKINGSTATUS WHERE NAME = 'CANCELLED'),1);
INSERT INTO BOOKING (USER_ID,PRODUCT_ID,DELIVERY_ADDRESS,DELIVERY_DATE,DELIVERY_TIME,BOOKINGSTATUS_ID,QUANTITY) VALUES ((SELECT USER_ID FROM USERS WHERE NAME = 'Andrea'),(SELECT PRODUCT_ID FROM PRODUCT WHERE NAME = 'To Kill a Mockingbird'),(SELECT ADDRESS FROM USERS WHERE NAME = 'Andrea'),'2024-07-14', '06:23',(SELECT BOOKINGSTATUS_ID FROM BOOKINGSTATUS WHERE NAME = 'SUBMITTED'),1);
...
INSERT INTO BOOKSTORE (PRODUCT_ID, AVAILABLE_QTY, BOOKED_QTY, SOLD_QTY) VALUES ((SELECT PRODUCT_ID FROM PRODUCT WHERE NAME = 'The adventures of Tom Sawyer'),300, 35,38);
